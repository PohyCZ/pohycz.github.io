...
function loadDictionary(a){defaultLang=a;switch(a){case "en":path="words/en.txt";letters=defaultLetters.en;setTexts(texts.en);$("#cs").attr("class","btn btn-default btn-lang");$("#en").attr("class","btn btn-primary btn-lang");break;case "cs":path="words/cs.txt",letters=defaultLetters.cs,setTexts(texts.cs),$("#en").attr("class","btn btn-default btn-lang"),$("#cs").attr("class","btn btn-primary btn-lang")}$.ajax({type:"get",url:path,success:function(a){words=a.toLowerCase().split("\n");loaded=!0}})}
function setTexts(a){$("#wordSize").attr("placeholder",a.wordSize);$("#letters").attr("placeholder",a.letters);$("#getWords").val(a.getWords);$("#result").html(a.result);$("#mail").html(a.mail)}
